...
export function Posts({ posts }: { posts: PostsType }) {
  ...
  const rawArticles: Article[] = [
    ...
    },
    {
      ...
      category: "company",
      image:
        "https://res.cloudinary.com/dohqjvu9k/image/upload/v1755685985/blog-4_lojema.jpg",
      date: "Oct 5, 2025",
      href: "#",
      authors: [
        { name: "Shadcn", image: SHADCN_AVATAR },
    ...
    },
    {
      ...
      category: "company",
      image:
        "https://res.cloudinary.com/dohqjvu9k/image/upload/v1755685985/blog-5_gpo4j1.png",
      date: "Oct 15, 2025",
      href: "#",
    ...
    },
    {
      ...
      category: "marketing",
      image:
        "https://res.cloudinary.com/dohqjvu9k/image/upload/v1755686429/blog-7_rlrsyt.jpg",
      date: "Nov 1, 2025",
      href: "#",
    ...
    },
    {
      ...
      category: "newsroom",
      image:
        "https://res.cloudinary.com/dohqjvu9k/image/upload/v1755685984/blog-5_widlus.jpg",
      date: "Dec 5, 2025",
      href: "#",
    ...
    },
    {
      ...
      category: "newsroom",
      image:
        "https://res.cloudinary.com/dohqjvu9k/image/upload/v1755686412/blog-6_epbcd1.jpg",
      date: "Dec 5, 2025",
      href: "#",
      ...
      <div className="bg-foreground/9 @container">
        <div className="grid-cols-[1fr_auto_1fr] lg:grid">
          ...
          <div className="lg:min-w-5xl mx-auto max-w-5xl p-[0.5px] lg:w-full">
            <div className="bg-card/75 lg:bg-card h-full rounded-md py-3 md:px-6">
              <div
        ...
        <div className="grid grid-cols-[1fr_auto_1fr]">
          ...
          <div className="lg:min-w-5xl mx-auto w-full max-w-5xl p-[0.5px]">
            <div className="bg-foreground/1 h-full rounded-md">
              {posts.items.length > 0 && (
                <div className="relative">
                  <div className="grid gap-px sm:grid-cols-2 lg:grid-cols-3">
                    {posts.items.map((article, index) => (
                      <article
                        key={`${article.title}-${article.created_at}-${index}`}
                        className="bg-card hover:bg-card/75 group relative flex flex-col space-y-4 rounded-md p-6 duration-200"
                      >
                        ...
                        <div className="mt-auto grid grid-cols-[1fr_auto] items-end gap-2 pt-4">
                          <div className="space-y-2">
                            {article.author_name && article.author_image && (
                              <div
                                key={index}
                                className="grid grid-cols-[auto_1fr] items-center gap-2"
                              >
                                <div className="bg-card aspect-square size-6 overflow-hidden rounded-md border shadow-md">
                                  <img
